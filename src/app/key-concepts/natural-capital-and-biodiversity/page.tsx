...
export default function Biodiversity() {
  return (
    <>
      <div className="h-[430px] w-full bg-[url(/assets/biodiversity-hero-background.png)] bg-cover bg-no-repeat pb-10 lg:h-[642px] lg:bg-[url(/assets/biodiversity-hero-background.png)] lg:pb-20">
      ...
      <main className="-mt-[270px] pr-6 lg:max-w-[1035px] lg:pr-20">
        ...
        <div className="flex flex-col gap-6 bg-pink p-6 lg:pl-14 xl:w-[calc(100vw_-_((100vw_-_1280px)_/_2)_-_60px)] xl:pl-[calc((100vw_-_1280px)_/_2_+_60px)]">
          ...
          <div className="w-full border-t border-t-grey-800"></div>
      ...
      <div className="mx-auto max-w-7xl bg-white px-6 py-6 text-grey-800 lg:px-[60px] lg:py-14">
        <div className="flex flex-col items-center gap-10 pb-10 lg:gap-20 lg:pb-20">
            ...
            <div className="flex w-full flex-col items-center justify-center gap-9 lg:flex-row">
              <figure className="relative">
                ...
                <div className="absolute inset-0 flex h-full w-full items-center justify-center">
                  <figcaption className="h-11 rounded-[40px] bg-grey-800/80 px-5 py-2.5 text-center text-white lg:h-14 lg:px-6 lg:py-4">
                    Photosynthesis
                  </figcaption>
                </div>
              </figure>
          ...
          <div className="flex w-full items-center justify-center">
            <div className="w-full lg:pl-[308px]">
              <div className="flex flex-col gap-10 lg:max-w-[559px]">
        ...
        <div className="-mx-6 border-t border-dashed border-t-grey-800 p-6 lg:mx-0 lg:pb-0 lg:pt-20">
          <div className="mx-auto flex max-w-7xl justify-between gap-x-16">
