...
export const REFERENCES = [
  <>
    Natural Capital Coalition (2016) <i>Natual Capital Protocol.</i> Available at{" "}
    <Link
  ...
  <>UN SEEA-Central Framework (2014)</>,
  <>
  ...
  <>
    FAO and UNEP. (2020) <i>The State of the World’s Forests 2020.</i> Forests, biodiversity and
    people. Rome.{" "}
    <Link
      className="text-blue-500 underline"
  ...
  <>
    ...
    <Link
      ...
      rel="noopener noreferrer"
    >
      https://doi.org/10.1071/CP17242
    </Link>
  </>,
  <>
    Gagic, V., Paull, C. & Schellhorn, N. A. (2018) Ecosystem service of biological pest control in
  ...
  <>
    Gijsman, R., Horstman, E.M., van der Wal, D. <i>et al.</i> (2021) Nature-based engineering: a
    ...
    <Link
      ...
      rel="noopener noreferrer"
    >
      https://www.frontiersin.org/articles/10.3389/fmars.2021.702412
    </Link>
  </>,
  <>
